...
export default function ResultCard({ 
    ...
    return (
        <div className="bg-[#1a1b2e] p-6 rounded-xl shadow-lg">
            ...
            <div className="bg-[#232539] p-4 rounded-lg flex justify-between items-center mb-3">
                <div>
                    <strong className="text-lg block mb-1">{deviceName}</strong>
            ...
            {showAttackButton && (
                <button 
                    ...
                    className="bg-[#3498db] text-white px-6 py-2.5 rounded-lg
